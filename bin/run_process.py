...
data_dir="/data/var_analysis/ATCA/Code/"
epoch="epoch1"
ATCA_band="C"
pri="1934_cal_CX"
sec="j2327-4510"
tar="001513"
tar_nm="J001513"
execfile(data_dir+"bin/process.py")
...
flag_ms(visname, epoch, ATCA_band, pri, sec, tar, tar_nm)
...
measureflux_ms(targetms, tar_ms, epoch, ATCA_band, sourcepar, n_spw, tar,
               tar_nm)
